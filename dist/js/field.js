...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-map-address', __webpack_require__(3));
    Vue.component('detail-map-address', __webpack_require__(6));
    Vue.component('form-map-address', __webpack_require__(9));
});
